...
def _assert_no_bool_arguments(p: argparse.ArgumentParser):
    for arg in p._actions:
        if arg.type is bool:
            raise ValueError('Found a bool arg type. Use str2bool!!!')
