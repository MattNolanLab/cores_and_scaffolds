...
from sf_examples.dmlab.dmlab30 import (
    DMLAB30_LEVELS,
    DMLAB30_NAVIGATION_LEVELS,
    DMLAB30_LITTLENAVIGATION_LEVELS,
...
DMLAB_ENVS = [
    ...
    DmLabSpec("dmlab30_navigation", [dmlab30_level_name_to_level(lvl) for lvl in DMLAB30_NAVIGATION_LEVELS]),
    DmLabSpec("dmlab30_littlenavigation", [dmlab30_level_name_to_level(lvl) for lvl in DMLAB30_LITTLENAVIGATION_LEVELS]),
    ...
    DmLabSpec("dmlab_custom", "/home/user/programming/neuralhorrors/libraries/sample-factory/sf_examples/dmlab/custom_dmlab/playground.lua"),

    *[DmLabSpec(f'dmnav_{env}', f'contributed/dmlab30/{env}') for env in DMLAB30_NAVIGATION_LEVELS]
]
...
def make_dmlab_env_impl(
    ...
    **_kwargs,
    ...
    # Hacky way to determine if we're in eval mode. policy_index only exists in cfg when we're evaluating (no matter what the value)
    is_eval = 'policy_index' in cfg
